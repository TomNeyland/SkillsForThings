...
| `conducting` | Method / quality multiplier | “Parallel agents can each finish their part while the combined system still fails at the boundaries.” | Split owned work, review each result, connect real producers to consumers, then inspect the assembled whole for missing connections |
